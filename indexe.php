   ...
   <body>
      <header>
            ...
            <div class="container">
               <div class="top-sec d-grid">
                     <ul  class="d-flex list-unstyled m-0 left-info">
                        ...
                        <li class="">
                           <a href="mailto:mayuri.infospace@gmail.com" class="d-md-block d-none">gobernacion@gmail.com</a>
                        </li>
                     </ul>
                  <div>
         ...
         <nav class="navbar navbar-expand-lg bg-white">
          <div class="container">
            <a class="navbar-brand" href="#"><img src="assets/images/avatar10.png" style="height: 70px"></a>
